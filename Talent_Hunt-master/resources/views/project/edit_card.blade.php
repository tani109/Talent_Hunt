                ...
                <div class="card edit">
                    <div class="single edit-field">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('name', null, ['id' => 'name', 'class' =>'form-control', 'placeholder' => 'Write the name of your project']) !!}
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::textarea( 'details', null, [ 'id' => 'details', 'class' => 'form-control', 'placeholder' => 'Write Details abour your project' ]) !!}
                        </div>
